...
module.exports = (env, argv) => ({
  ...
  */
    ...
    */
    !env.prod && new AfterCompilePlugin({
      run: () => {
        ...
        console.log(`💻  => Application running in browser at http://54.242.100.85:${DEV_SERVER_PORT}\n\n`)
      }
    })
  ].filter(Boolean),
  ...
  devServer: {
    ...
    */
    public: `http://54.242.100.85:${DEV_SERVER_PORT}`,
    ...
    */
    proxy: API_WEBPACK ? {
      [API_WEBPACK]: {
        target: `http://54.242.100.85:${API_PORT}`,
